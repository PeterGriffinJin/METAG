...
def main():
    ...
    test_dataset = EvalDataset(tokenizer, 'test', data_args, shuffle_seed=None, cache_dir=data_args.data_cache_dir or model_args.cache_dir)
    test_dataset.load_task_n2id(data_args.train_dir)
