...
from OpenLP.dataset import TrainNCCCollator, EvalNCCDataset
...
def main():
    ...
    test_dataset = EvalNCCDataset(tokenizer, data_args, shuffle_seed=training_args.seed, cache_dir=data_args.data_cache_dir or model_args.cache_dir)
    test_dataset[0]
